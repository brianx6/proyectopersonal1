...
for i in range(clientes):
       ...
       while True:
        ...
        hola = str(input(f"tus articulos de compra son {nombres}\ndeseas devolver algun producto si/no? ")).upper()
        if hola == "SI":
            ...
            if product == artis:
                if product > 2 and artis > 2:
                    ...
                    print(f"el articulo {artinom} fue devueltoo por el monto de {tarje2}")
            elif product != artis:
                if tarje == "TARJETA":
